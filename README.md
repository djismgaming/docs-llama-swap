...
A minimal repository for my local llama-swap project documentation and configuration. To use with [Llama-swap](https://github.com/mostlygeek/llama-swap)
...
```posh
llama-swap -watch-config -config c:\Users\<user>\code\docs-llama-swap\config.yaml
```
